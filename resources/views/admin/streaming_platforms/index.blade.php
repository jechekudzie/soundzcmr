    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                <div>
                    <h4 class="mb-3 mb-md-0">Streaming Platforms</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="dataTableExample" class="col-g-12 col-md-12 table">
                                    ...
                                    <tbody>
                                    @foreach($streaming_platforms as $streaming_platform)
                                        <tr>
                                            <td>{{$streaming_platform->name}}</td>
                                            <td>Events
                                                ({{$streaming_platform->event_streaming_platforms->count()}})
                                            </td>
                                            <td>
                                                <a href="{{url('admin/streaming_platforms/'.$streaming_platform->id)
                                                }}">View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Streaming Platform</h5>
