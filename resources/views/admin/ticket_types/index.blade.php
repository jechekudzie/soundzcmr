                                ...
                                <table id="dataTableExample" class="col-g-12 col-md-12 table">
                                    ...
                                    @foreach($ticket_types as $ticket_type)
                                        <tr>
                                            ...
                                            <td>Events ({{$ticket_type->events->count()}})</td>
                                            <td>
                                                <a href="{{url('admin/ticket_types/'.$ticket_type->id)}}">View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Ticket type</h5>
