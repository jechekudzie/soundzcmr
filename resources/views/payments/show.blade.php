                    ...
                    <div class="modal-content">
                        ...
                        .$item->id)
                            ...
                            <div class="modal-body">
                                <div class="card">
                                    <div class="card-body">
                                        <h6 class="card-title">Edit {{$item->name}}</h6>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" class="form-control"
                                                      id="colFormLabel">{{$item->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form method="post" enctype="multipart/form-data"
                              action="{{url('/admin/items/'.$item->id)  }}">
                            @csrf
                            @method('DELETE')
                            <div class="modal-body">
                                <div class="card">
                                    <div class="card-body">
                                        <h6 class="card-title">Delete {{$item->name}} ? </h6>
